	...
	case "add":
		if(isset($_POST["quantity"])) {
			...
			while($data = mysqli_fetch_assoc($result)) {
                $itemArray = [ $data["code"]=>array('name'=>$data["name"], 'code'=>$data["code"], 'quantity'=>$_POST["quantity"], 'price'=>$data["price"], 'image'=>$data["image"])];
...
<BODY>
    <div id="shopping-cart">
        ...
        <a id="btnEmpty" href="order.php?action=add">สั่งซื้อ</a>
...
?>
    ...
    <div id="product-grid">
        ...
        <div class="product-item">
            <form method="post" action="index.php?action=add&code=<?php echo $data["code"]; ?>">
                <div class="product-image"><img src="./product-images/<?php echo $data["image"]; ?>">
                </div>
